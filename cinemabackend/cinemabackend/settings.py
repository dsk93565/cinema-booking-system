"""
Django settings for cinemabackend project.
...
SECRET_KEY = 'django-insecure-0m#dovw^5t!u2br#1b@%bp^b@z+9jvcz!y_^&-^c7c3vz_)_o@'
...
#NEED TO SETUP THE .env file to run the smtp serve with EMAIL_HOST_USER and PASSWORD
...
WSGI_APPLICATION = 'cinemabackend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': 'we$%^789',
        'HOST': '172.25.182.64',  # or the hostname of your MySQL server
